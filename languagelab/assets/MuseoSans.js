...
if (myfonts_webfont_test)
	document.write('<script type="text/javascript" src="' +path+ '/MyFontsWebfontsOrderM2870103_test.js"></script>');
...
switch (webfontType)
{
		...
		document.write("<style>\n");
				document.write("@font-face {font-family:\"MuseoSans-500\";src:url(\"" + path + "/style_159303.eot\");}\n");
				document.write("</style>");
		break;
		
		case 'woff':
		document.write("<style>\n");
				document.write("@font-face {font-family:\"MuseoSans-500\";src:url(\"" + path + "/style_159303.woff\") format(\"woff\");}\n");
				document.write("</style>");
		break;
	
		case 'data-css':
		document.write("<link rel='stylesheet' type='text/css' href='" + path + "/MuseoSans.css'>");
		break;
	
		case 'svg':
		document.write("<style>\n");
				document.write("@font-face {font-family:\"MuseoSans-500\";src:url(\"" + path + "/style_159303.svg#MuseoSans-500\") format(\"svg\");}\n");
				document.write("</style>");
		break;
